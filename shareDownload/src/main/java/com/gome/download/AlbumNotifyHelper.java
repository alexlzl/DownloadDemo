...
public class AlbumNotifyHelper {
    ...
    public static void insertVideoToMediaStore(Context context, String filePath, long dateTaken, long duration,int width, int height) {
        insertVideoToMediaStore(context, filePath, dateTaken, width, height, duration);
    }
